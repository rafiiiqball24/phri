  ...
  <section class="about">
    <header class="hero">
      ...
      <figure class="hero__right">
        <img src="/img/shop/aboutus.webp" alt="Etalase PHRI Shop" />
      </figure>
    </header>
    ...
    <section class="intro container">
      ...
      <figure class="intro__media card">
        <img src="/img/shop/aboutus2.webp" alt="Team collaboration" />
      </figure>
    </section>
...
.hero__left {
  ...
  background: url("/img/shop/aboutus3.webp") center/cover no-repeat;
  min-height: 420px;
}
...
.vm__icon {
  ...
  background: var(--black-black-50020, rgba(158, 158, 158, 0.2));
}
